...
function LinkCard({
  ...
  return (
    <a
      href={href}
      className="flex item-center p-1 w-full rounded-md hover:scale-105 transition-all bg-gray-200 mb-3"
    >
      <div className="flex text-center items-center w-full">
        ...
        <Image
          ...
          alt={title}
        />
        <h2 className="font-semibold w-full text-gray-800 -ml-10">{title}</h2>
